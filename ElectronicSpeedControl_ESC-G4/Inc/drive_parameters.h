...
#define PLL_KP_GAIN                         1837
#define PLL_KI_GAIN                         65
...
#define DEFAULT_TARGET_SPEED_RPM            5000
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V              14.4 /*!< Over-voltage threshold */
...
#define PHASE1_FINAL_CURRENT_A              2.0

/* Phase 2 */
#define PHASE2_DURATION                     1600 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (2200*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              2.0

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (2200*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              2.0

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (2200*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              2.0

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (2200*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              2.0

...
/**
  ...
  * @param  error_now Buffer of returned bitfields containing error flags
  *         coming from GAP device that are currently active.\n
  *         The buffer have to be provided from the caller.
  * @param  error_occurred Buffer of returned bitfields containing error flags
...
/**
  ...
  * @param  data_in 16bit value with data as MSB and CRC as LSB.

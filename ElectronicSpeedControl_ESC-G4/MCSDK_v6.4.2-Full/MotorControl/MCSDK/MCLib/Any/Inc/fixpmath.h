...
#define FIXP_MPY_64(a, b, n)	(((int64_t) (a) * (b)) >> (n))
...
#ifdef FIXP_PRECISION_FLOAT
#define FIXP0_toF(A)	((float_t) (A))
#define FIXP1_toF(A)	((float_t)(((float_t) (A)) / 2.0f))
#define FIXP2_toF(A)	((float_t)(((float_t) (A)) / 4.0f))
#define FIXP3_toF(A)	((float_t)(((float_t) (A)) / 8.0f))
#define FIXP4_toF(A)	((float_t)(((float_t) (A)) / 16.0f))
#define FIXP5_toF(A)	((float_t)(((float_t) (A)) / 32.0f))
#define FIXP6_toF(A)	((float_t)(((float_t) (A)) / 64.0f))
#define FIXP7_toF(A)	((float_t)(((float_t) (A)) / 128.0f))
#define FIXP8_toF(A)	((float_t)(((float_t) (A)) / 256.0f))
#define FIXP9_toF(A)	((float_t)(((float_t) (A)) / 512.0f))
#define FIXP10_toF(A)	((float_t)(((float_t) (A)) / 1024.0f))
#define FIXP11_toF(A)	((float_t)(((float_t) (A)) / 2048.0f))
#define FIXP12_toF(A)	((float_t)(((float_t) (A)) / 4096.0f))
#define FIXP13_toF(A)	((float_t)(((float_t) (A)) / 8192.0f))
#define FIXP14_toF(A)	((float_t)(((float_t) (A)) / 16384.0f))
#define FIXP15_toF(A)	((float_t)(((float_t) (A)) / 32768.0f))
#define FIXP16_toF(A)	((float_t)(((float_t) (A)) / 65536.0f))
#define FIXP17_toF(A)	((float_t)(((float_t) (A)) / 131072.0f))
#define FIXP18_toF(A)	((float_t)(((float_t) (A)) / 262144.0f))
#define FIXP19_toF(A)	((float_t)(((float_t) (A)) / 524288.0f))
#define FIXP20_toF(A)	((float_t)(((float_t) (A)) / 1048576.0f))
#define FIXP21_toF(A)	((float_t)(((float_t) (A)) / 2097152.0f))
#define FIXP22_toF(A)	((float_t)(((float_t) (A)) / 4194304.0f))
#define FIXP23_toF(A)	((float_t)(((float_t) (A)) / 8388608.0f))
#define FIXP24_toF(A)	((float_t)(((float_t) (A)) / 16777216.0f))
#define FIXP25_toF(A)	((float_t)(((float_t) (A)) / 33554432.0f))
#define FIXP26_toF(A)	((float_t)(((float_t) (A)) / 67108864.0f))
#define FIXP27_toF(A)	((float_t)(((float_t) (A)) / 134217728.0f))
#define FIXP28_toF(A)	((float_t)(((float_t) (A)) / 268435456.0f))
...
#else /* FIXP_PRECISION_FLOAT */
#define FIXP0_toF(A)	((float_t) (A))
#define FIXP1_toF(A)	((float_t)(((float_t) (A)) / 2.0L))
#define FIXP2_toF(A)	((float_t)(((float_t) (A)) / 4.0L))
#define FIXP3_toF(A)	((float_t)(((float_t) (A)) / 8.0L))
#define FIXP4_toF(A)	((float_t)(((float_t) (A)) / 16.0L))
#define FIXP5_toF(A)	((float_t)(((float_t) (A)) / 32.0L))
#define FIXP6_toF(A)	((float_t)(((float_t) (A)) / 64.0L))
#define FIXP7_toF(A)	((float_t)(((float_t) (A)) / 128.0L))
#define FIXP8_toF(A)	((float_t)(((float_t) (A)) / 256.0L))
#define FIXP9_toF(A)	((float_t)(((float_t) (A)) / 512.0L))
#define FIXP10_toF(A)	((float_t)(((float_t) (A)) / 1024.0L))
#define FIXP11_toF(A)	((float_t)(((float_t) (A)) / 2048.0L))
#define FIXP12_toF(A)	((float_t)(((float_t) (A)) / 4096.0L))
#define FIXP13_toF(A)	((float_t)(((float_t) (A)) / 8192.0L))
#define FIXP14_toF(A)	((float_t)(((float_t) (A)) / 16384.0L))
#define FIXP15_toF(A)	((float_t)(((float_t) (A)) / 32768.0L))
#define FIXP16_toF(A)	((float_t)(((float_t) (A)) / 65536.0L))
#define FIXP17_toF(A)	((float_t)(((float_t) (A)) / 131072.0L))
#define FIXP18_toF(A)	((float_t)(((float_t) (A)) / 262144.0L))
#define FIXP19_toF(A)	((float_t)(((float_t) (A)) / 524288.0L))
#define FIXP20_toF(A)	((float_t)(((float_t) (A)) / 1048576.0L))
#define FIXP21_toF(A)	((float_t)(((float_t) (A)) / 2097152.0L))
#define FIXP22_toF(A)	((float_t)(((float_t) (A)) / 4194304.0L))
#define FIXP23_toF(A)	((float_t)(((float_t) (A)) / 8388608.0L))
#define FIXP24_toF(A)	((float_t)(((float_t) (A)) / 16777216.0L))
#define FIXP25_toF(A)	((float_t)(((float_t) (A)) / 33554432.0L))
#define FIXP26_toF(A)	((float_t)(((float_t) (A)) / 67108864.0L))
#define FIXP27_toF(A)	((float_t)(((float_t) (A)) / 134217728.0L))
#define FIXP28_toF(A)	((float_t)(((float_t) (A)) / 268435456.0L))
...
#define FIXP0_mpy(a, b)		FIXP_MPY((a), (b), 0)
...
#define FIXP20_div(a, b)	FIXP_DIV((a), (b), 20)
#define FIXP24_div(a, b)	FIXP_DIV((a), (b), 24)
...
#define FIXP0_rsmpy(a, b)	FIXP_MPY((a), (b), 0)
...
#define FIXP_add_sat32(A, B)        __QADD(A, B)

/* Absolute */
#define FIXP_abs(A)					((A) >= 0 ? (A) : -(A))
#define FIXP30_abs(A) FIXP_abs(A)

typedef fixp_t fixp0_t;
...
static inline fixp_t FIXP_mpyFIXPscaled_sat32(const fixp_t a, const FIXP_scaled_t *pFps)
{
    /* Returned value is in the same format as parameter a, saturated to 32bits to prevent overflow */
    int64_t r = FIXP_MPY_64(a, pFps->value, pFps->fixpFmt);
    return FIXP_sat(r, INT32_MAX, INT32_MIN);
}

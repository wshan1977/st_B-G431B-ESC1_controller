/**
  ...
  *
  ******************************************************************************
  * @ingroup speed_pos_fdbk_sixstep
  */
...
/** @addtogroup speed_pos_fdbk_sixstep
  * @{
  */

/* Exported types ------------------------------------------------------------*/
/**
  * @brief  SpeednPosFdbk_6S_Handle_t  handles definitions of mechanical and electrical speed, mechanical acceleration, mechanical

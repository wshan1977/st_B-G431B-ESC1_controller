...
#define R3_3_OPAMP
/**
  * @brief  Current feedback component defining parameters for 3-OPAMP configurations. Specific to G4XX.
  */
typedef const struct
{
  ...
  uint32_t OPAMPConfig1[6];                 /*!< OPAMP_CSR_OPAMPINTEN and OPAMP_CSR_VPSEL configuration for each ADC conversion. */ 
  uint32_t OPAMPConfig2[6];                 /*!< OPAMP_CSR_OPAMPINTEN and OPAMP_CSR_VPSEL configuration for each ADC conversion. */ 
...
typedef const struct
{
  ...
  R3_3_OPAMPParams_t *OPAMPParams;          /*!< Pointer to the 3-OPAMP params struct.
                                                  Must be #MC_NULL if internal OPAMP are not used. Specific to G4XX. */
...
typedef struct
{
  ...
  uint16_t ADCTriggerEdge;              /* External trigger selection for ADC peripheral */
